...
const clientFiles=['index.html','style.css','accounts.css','layout.mjs','data.mjs','model.mjs','account-model.mjs','account-ui.mjs','adoption.mjs','workspace.mjs','comparison-layout.mjs','compare-canvas.mjs','participation-ui.mjs','workspace-ui.mjs','app.mjs','beta-boot.mjs'];
const assets={};
...
export default {async fetch(request,env){
  ...
  headers.set('content-security-policy',"default-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline'; img-src 'self' data:; connect-src 'self'; object-src 'none'; base-uri 'none'; frame-ancestors 'none'; form-action 'self'");
